...
CSRF_TRUSTED_ORIGINS = ['https://radutinskih.medblogers-base.ru', 'http://127.0.0.1']

ALLOWED_HOSTS = ["radutinskih.medblogers-base.ru", "127.0.0.1", "localhost"]
...
ROOT_URLCONF = 'radutinskih_forms.urls'
...
WSGI_APPLICATION = 'radutinskih_forms.wsgi.application'
